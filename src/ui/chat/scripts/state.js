...
const contextUsageTooltip = document.getElementById('contextUsageTooltip');
const contextUsageTitle = document.getElementById('contextUsageTitle');
const contextUsageSummary = document.getElementById('contextUsageSummary');
const contextUsageDetail = document.getElementById('contextUsageDetail');
